package loc.com.myapplication.Until.Menu;
 ...
 */
public class CustomeMenu extends RelativeLayout {

    private static final String TAG = CustomeMenu.class.getSimpleName();
...
//    private ImageView rightMask;
    ...
    public CustomeMenu(Context context) {
        this(context, null);
    }

    public CustomeMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomeMenu(Context context, AttributeSet attrs, int defStyleAttr) {
